...
Le service retourne un flux de données XML ou JSON contenant un compte-rendu d'exécuti
Les paramètres doivent être passés par la méthode GET :
    http://<hébergeur>/tracegps/api/ChangerDeMdppseudo=europa&mdp=13e3668bbee30b004380052b086457b014504b3e&nouveauMdp=123&confirmationMdp=123&lang=x
*/
...
{	$msg = "Erreur : méthode HTTP incorrecte.";
    ...
    if ( $adrMail == "" || $mdpSha1 == "" || $nouveauMdp == "" || $confirmationMdp == "" ) {
        ...
        if ( strlen($nouveauMdp) < 8 ) {
        	...
        	if ( $nouveauMdp != $confirmationMdp ) {
        		...
        		if ( $dao->getConnexion($adrMail, $mdpSha1) == 0 ) {
