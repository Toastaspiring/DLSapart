...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    dLSapartAuthUserSubject.add(
      DLSapartAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<DLSapartAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  DLSapartAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = DLSapartAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    dLSapartAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
