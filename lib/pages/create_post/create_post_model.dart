...
class CreatePostModel extends FlutterFlowModel<CreatePostWidget> {
  ...
  ApiCallResponse? resultUpload;
  // Stores action output result for [Backend Call - API (CreerUneAnnonce)] action in Button widget.
  ApiCallResponse? resultCreationAnnonce;
