...
class _MyPostsWidgetState extends State<MyPostsWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: GetMesannoncesCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final myPostsGetMesannoncesResponse = snapshot.data!;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final mesAnnonces = GetMesannoncesCall.lesAnnonces(
                                myPostsGetMesannoncesResponse.jsonBody,
                              )?.toList() ??
                              [];
                          return ListView.builder(
                            ...
                            itemBuilder: (context, mesAnnoncesIndex) {
                              final mesAnnoncesItem =
                                  mesAnnonces[mesAnnoncesIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 1.0),
                                child: InkWell(
